...
import org.remusystem.persistencia.AsignacionFamiliar;
import org.remusystem.persistencia.AsignacionFamiliarDAO;
...
import org.remusystem.persistencia.InfoComplementaria;
import org.remusystem.persistencia.InfoComplementariaDAO;
...
import org.remusystem.persistencia.SeguroCesantia;
import org.remusystem.persistencia.SeguroCesantiaDAO;
...
public class CalcularSueldoTrabajador extends ActionSupport implements SessionAware{
	...
	public String execute(){
         ...
         */
			...
			addActionError("Ya ha generado la liquidacion de sueldo correspondiente al mes actual");
			return ERROR;
		}
}
