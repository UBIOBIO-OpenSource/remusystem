...
public class ReporteExcelTrabajador extends ActionSupport implements SessionAware{
	...
	public String execute(){
		...
		try{
		    ...
		    //hay que crear un nombre temporal único, no uno genérico  como reporteExcel, porque esto trae problemas cuando hay concurrencia.
		    ...
		    try { //con esto abro el pdf creado
		    	   File path = new File ("reporteExcel.xls");
