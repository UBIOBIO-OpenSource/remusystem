...
<html>
  <head>
    ...
    <title>Modificar Mis Datos Empresa</title>
  ...
  <script type="text/javascript" src="js/validaModEmp.js"></script> <!-- revisa el formulario -->
...
<!-- content -->
	<section id="content">
		<div class="wrapper">
			<div class="pad">
				<div class="wrapper">
					<article class=""><h3>Modificar Datos Empresa</h3></article>
					</div>
			</div>
			<div class="box pad_bot1 bot">
				<div class="pad marg_top">
    ...
    <s:password cssClass="bg" label="Nueva Password" name="pw_new" id="pw_new" />
    <s:password cssClass="bg" label="Confirmar Nueva password" name="pw_confirm" id="pw_confirm" />
    <s:textfield cssClass="bg" label="Giro" name="gir_emp" id="gir_emp" value="%{#session.empresa.getGiro()}" title="ingrese el giro de la empresa"/>
    <s:textfield cssClass="bg" label="Dirección" name="dir_emp" id="dir_emp" value="%{#session.empresa.getDireccion()}" title="ingrese la dirección de la empresa"/>
    <s:textfield cssClass="bg" label="Telefono" name="tel_emp" id="tel_emp" value="%{#session.empresa.getTelefono()}" title="ingrese el telefono de la empresa" onchange="javascript: Tel(this.value);" />
    <s:textfield cssClass="bg" label="Fax" name="fax_emp" id="fax_emp" value="%{#session.empresa.getFax()}" title="ingrese el fax de la empresa" onchange="javascript: Fax(this.value);" />
    <s:textfield cssClass="bg" label="Email" name="email_emp" id="email_emp" value="%{#session.empresa.getEmail()}" title="ingrese el email de contacto de la empresa" onchange="javascript: Email(this.value);" />
