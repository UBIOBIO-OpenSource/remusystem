...
public class ReportePDF extends ActionSupport implements SessionAware{
	...
	public String execute(){
		...
		try{
		    ...
		    exporter.setParameter(JRExporterParameter.OUTPUT_FILE, new java.io.File("C:\\Users\\Krlituss\\Workspaces\\MyEclipse 8.5\\SistemaRem\\WebRoot\\reportes\\reportePDF.pdf"));
		    exporter.exportReport();
		    try { //con esto abro el pdf creado
		    	   File path = new File ("C:\\Users\\Krlituss\\Workspaces\\MyEclipse 8.5\\SistemaRem\\WebRoot\\reportes\\reportePDF.pdf");
